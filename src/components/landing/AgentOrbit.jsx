    ...
    <div style={{ position: "relative", width: 560, height: 560, flexShrink: 0 }}>
      ...
      <div
        style={{
          ...
          height: 350,
          borderRadius: "50%",
          border: "1px dashed rgba(42,157,143,0.20)",
          top: 105,
          left: 105,
          pointerEvents: "none",
          zIndex: 1,
      ...
      <div
        style={{
          ...
          height: 270,
          borderRadius: "50%",
          border: "1.5px solid rgba(42,157,143,0.07)",
      ...
      <div
        style={{
          ...
          borderRadius: "50%",
          background: "#fff",
          boxShadow: "0 24px 64px rgba(123,116,220,0.12), 0 4px 16px rgba(123,116,220,0.06)",
          display: "flex",
          ...
          <AnimatePresence key={`${agent.id}-${i}`} mode="wait">
            <motion.div
              ...
              style={{
                ...
                boxShadow: `0 8px 28px rgba(123,116,220,0.10), 0 2px 8px rgba(123,116,220,0.06)`,
                zIndex: 6,
                minWidth: 158,
                maxWidth: 192,
              }}
        ...
        {AGENTS.map((a, i) => (
          <button
            ...
            style={{
              ...
              height: 6,
              borderRadius: 3,
              background: activeIndex === i ? agent.color : "rgba(123,116,220,0.15)",
              border: "none",
              cursor: "pointer",
              padding: 0,
